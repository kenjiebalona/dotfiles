...
alias c="clear"
alias gbc='git branch --sort=-committerdate | fzf --header "Checkout Recent Branch" --preview "git diff {1} | delta" --pointer="" | xargs git checkout'
alias pn="pnpm"
alias dsize="/bin/ls -d */ | xargs -I {} du -sh {}"
